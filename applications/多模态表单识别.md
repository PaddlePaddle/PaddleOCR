...
注：AI Studio在线运行代码请参考[多模态表单识别](https://aistudio.baidu.com/aistudio/projectdetail/3815918)(配备Tesla V100、A100等高级算力资源)
...
接着我们在上述`XFUND数据集+finetune`实验的基础上，添加真实通用识别数据，进一步提升识别效果。首先下载真实通用识别数据，并解压：


```python
%cd /home/aistudio/XFUND/
!wget http://10.21.226.133:8903/ocr_26W_baseline.tar
!tar -xvf ocr_26W_baseline.tar && rm -rf ocr_26W_baseline.tar
%cd /home/aistudio/PaddleOCR/
```
...
<center><img src='https://ai-studio-static-online.cdn.bcebos.com/fe1f7ad92c0c47ae95ba250925eaedf55a438aefa0cb4dff909177a07e86974e' width=''></center>
