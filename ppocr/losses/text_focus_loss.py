...
def weight_cross_entropy(pred, gt, confuse_dict_path):
    weight_table = load_confuse_matrix(confuse_dict_path)
    batch = gt.shape[0]
...
class TextFocusLoss(nn.Layer):
    def __init__(self, confuse_dict_path):
        ...
        self.confuse_dict_path = confuse_dict_path
    ...
    def forward(self, pred, data):
        ...
        recognition_loss = weight_cross_entropy(sr_pred, text_gt, self.confuse_dict_path)
