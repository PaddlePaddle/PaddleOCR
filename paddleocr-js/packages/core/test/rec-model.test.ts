        ...
        .mockResolvedValueOnce({
          output: {
            ...
            data: new Float32Array([
              0.1, 0.9, 0.2, 0.1, 0.2, 0.1, 0.8, 0.1, 0.8, 0.1, 0.1, 0.0, 0.2, 0.1, 0.8, 0.1, 0.2,
              0.1, 0.8, 0.1, 0.7, 0.2, 0.1, 0.0
            ])
          }
        })
        .mockResolvedValueOnce({
          output: {
            dims: [1, 3, 4],
            data: new Float32Array([0.1, 0.1, 0.8, 0.1, 0.1, 0.1, 0.8, 0.1, 0.6, 0.2, 0.1, 0.1])
          }
        })
    };
