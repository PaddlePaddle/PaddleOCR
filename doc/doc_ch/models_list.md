...
| ch_tramobile_v2.0_rec |中文繁体识别|rec_ch_tralite_train.yml|5.63M|[推理模型](https://paddleocr.bj.bcebos.com/dygraph_v2.0/multilingual/ch_tramobile_v2.0_rec_infer.tar) / [训练模型](https://paddleocr.bj.bcebos.com/dygraph_v2.0/multilingual/ch_tramobile_v2.0_rec_train.tar) |
