...
|模型名称|模型简介|配置文件|推理模型大小|下载地址|
| --- | --- | --- | --- | --- |
|en_PP-OCRv3_det_slim |【最新】slim量化版超轻量模型，支持英文、数字检测 | [en_PP-OCRv3_det.yml](../../configs/det/ch_PP-OCRv3/en_PP-OCRv3_det.yml)| - |[推理模型(coming soon)](https://paddleocr.bj.bcebos.com/PP-OCRv3/english/en_PP-OCRv3_det_slim_quant_infer.tar) / [nb模型(coming soon)](https://paddleocr.bj.bcebos.com/PP-OCRv3/english/en_PP-OCRv3_det_slim_quant_infer.nb) |
|ch_PP-OCRv3_det |【最新】原始超轻量模型，支持英文、数字检测|[en_PP-OCRv3_det.yml](../../configs/det/en_PP-OCRv3/en_PP-OCRv3_det.yml)| 3.7M | [推理模型](https://paddleocr.bj.bcebos.com/PP-OCRv3/english/en_PP-OCRv3_det_infer.tar) / [训练模型](https://paddleocr.bj.bcebos.com/PP-OCRv3/english/en_PP-OCRv3_det_train.tar) |
