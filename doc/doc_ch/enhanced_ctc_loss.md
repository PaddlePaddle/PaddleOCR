...
以配置文件`configs/rec/ch_PP-OCRv2/ch_PP-OCRv2_rec_enhanced_ctc_loss.yml`为例， center提取命令如下所示:
```
python tools/export_center.py -c configs/rec/ch_PP-OCRv2/ch_PP-OCRv2_rec_enhanced_ctc_loss.yml -o  Global.pretrained_model: "./output/rec_mobile_pp-OCRv2_enhanced_ctc_loss/best_accuracy"
```
