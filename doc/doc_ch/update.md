...
- 2022.5.9 发布PaddleOCR v2.5。发布内容包括：
    - [PP-OCRv3](./ppocr_introduction.md#pp-ocrv3)，速度可比情况下，中文场景效果相比于PP-OCRv2再提升5.00%，英文场景提升11.00%，80语种多语言模型平均识别准确率提升5.00%以上；
    - 半自动标注工具[PPOCRLabelv2](../../PPOCRLabel)：新增表格文字图像、图像关键信息抽取任务和不规则文字图像的标注功能；
    - OCR产业落地工具集：打通22种训练部署软硬件环境与方式，覆盖企业90.00%的训练部署环境需求
...
- 2021.9.7 发布PaddleOCR v2.3，发布[PP-OCRv2](#PP-OCRv2)，CPU推理速度相比于PP-OCR server提升220.00%；效果相比于PP-OCR mobile 提升7.00%。
...
- 2020.9.19 更新超轻量压缩ppocr_mobile_slim系列模型，整体模型3.50M(详见PP-OCR Pipeline)，适合在移动端部署使用。
