...
The `points` in the dictionary represent the coordinates (x, y) of the 14-points of the text box, arranged clockwise from the point at the upper left corner.
