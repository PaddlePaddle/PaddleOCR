...
| version                     | Model version number, the current model support list is as follows PP-OCRv2 Support Chinese detection and recognition model, PP-OCR support Chinese detection, recognition and direction classifier, multilingual recognition model and table structure model | PP-OCR                    |
