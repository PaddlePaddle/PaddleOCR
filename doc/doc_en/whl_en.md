...
First, refer to the fourth section of [export](./detection_en.md#4-inference) to convert your det and rec model to inference model, and then use it as follows
