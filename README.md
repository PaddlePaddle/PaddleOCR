...
- [**移动端DEMO**体验：基于EasyEdge和Paddle-Lite](https://ai.baidu.com/easyedge/app/openSource?from=paddlelite)(点击链接或直接扫描如下二维码)
<div align="center">
    <img src="./doc/mobile_demo_qrcode.png"  width = "700" height = "200" />
</div>
