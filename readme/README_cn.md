...
* **SOTA 级文档视觉语言模型 (VLM)**: 业界领先的轻量级文档解析视觉语言模型 **PaddleOCR-VL-1.6 (0.9B)**。它在五大"真实场景"中表现卓越：**弯曲、扫描、屏幕拍照、复杂光照及倾斜文档**，并支持以 **Markdown** 和 **JSON** 格式输出结构化结果。
...
* **PaddleOCR-VL-1.6 (Latest 0.9B VLM)**：
