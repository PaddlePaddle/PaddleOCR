...
* **PaddleOCR-VL-1.6 (Latest 0.9B VLM)**: Наша новейшая флагманская модель для разбора документов уже доступна!
