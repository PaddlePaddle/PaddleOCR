...
* **نموذج رؤية-لغة رائد للمستندات**: يتميز بنموذج **PaddleOCR-VL-1.6 (0.9B)**، النموذج خفيف الحجم الرائد في المجال للرؤية واللغة لتحليل المستندات. يتفوق في تحليل المستندات المعقدة عبر 5 تحديات رئيسية من "العالم الواقعي": **التشوه، المسح الضوئي، تصوير الشاشة، الإضاءة، والمستندات المائلة**، مع مخرجات منظمة بصيغ **Markdown** و**JSON**.
