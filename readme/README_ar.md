...
- أبرز مزايا PP-OCRv6:
    ...
    - **دعم 50 لغة موحد**: نموذج واحد يغطي الصينية والإنجليزية واليابانية و46 لغة لاتينية — لا حاجة لتبديل النماذج.
...
- أبرز مزايا PaddleOCR-VL-1.6:
    ...
    - **دقة SOTA جديدة**: 96.3% على OmniDocBench v1.6، SOTA جديد على OmniDocBench v1.5 وReal5-OmniDocBench.
    - **ترقية شاملة**: تحسينات كبيرة في الجداول والمستندات القديمة والأحرف النادرة.
    - **ترحيل سلس**: بنية متوافقة تماماً مع PaddleOCR-VL-1.5.
    - **جرّبه الآن**: [HuggingFace](https://huggingface.co/PaddlePaddle/PaddleOCR-VL-1.6) أو [الموقع الرسمي](https://www.paddleocr.com).
