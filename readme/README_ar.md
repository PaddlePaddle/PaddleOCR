...
### 🔥 2026.05.28: إصدار PaddleOCR 3.6.0
- أبرز مزايا PaddleOCR-VL-1.6:

    - **دقة SOTA جديدة**: يتجاوز 96.3% على OmniDocBench v1.6، ويحقق أيضاً SOTA جديداً على OmniDocBench v1.5 وReal5-OmniDocBench، متفوقاً على الحلول مفتوحة المصدر والمغلقة في التعرف على النصوص والصيغ والجداول.
    - **ترقية شاملة للقدرات**: تحسينات كبيرة في التعرف على الجداول والمستندات القديمة والأحرف النادرة، مع تعزيز ملحوظ للتعرف على الأختام وspotting وفهم الرسوم البيانية في سيناريوهات متعددة.
    - **ترحيل سلس**: بنية النموذج متطابقة تماماً مع PaddleOCR-VL-1.5، مما يتيح التكيف بدون تكلفة — استبدله واستخدمه فوراً.
    - **جرّبه الآن**: متاح على [HuggingFace](https://huggingface.co/PaddlePaddle/PaddleOCR-VL-1.6) أو [موقعنا الرسمي](https://www.paddleocr.com).

<details>
<summary><strong>2026.04.21: إصدار PaddleOCR 3.5.0</strong></summary>
