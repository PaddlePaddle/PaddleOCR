...
- [Document Visual Question Answering (DOC-VQA)](#Document Visual Question Answering doc-vqa)
  ...
  - [3. Effect Demonstration](#3-Effect Demonstration)
    - [3.1 SER](#31-ser)
    - [3.2 RE] (#32-re)
  - [4. INSTALL] (#4-INSTALL)
    - [4.1 Installation Dependencies](#41-Installation Dependencies)
    - [4.2 Install PaddleOCR (including PP-OCR and VQA)] (#42-Install paddleocr including -pp-ocr- and -vqa)
  - [5. use](#5-use)
    - [5.1 Data and Pre-trained Model Preparation] (#51 - Data and Pre-trained Model Preparation)
    - [5.2 SER] (#52-ser)
    - [5.3 RE] (#53-re)
  - [6. Reference link] (#6-reference link)
...
Use the following command to complete the series prediction of `OCR engine + SER`, taking the SER model mentioned above as an example:
...
Use the following command to complete the series prediction of `OCR engine + SER + RE`, taking the SER and RE models mentioned above as an example:
```shell
export CUDA_VISIBLE_DEVICES=0
#Download the SER model, if it has been downloaded, you can skip it
wget https://paddleocr.bj.bcebos.com/pplayout/ser_LayoutXLM_xfun_zh.tar && tar -xvf ser_LayoutXLM_xfun_zh.tar
#download RE model
