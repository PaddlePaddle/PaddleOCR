 ...
 * **系统性能优化** ：
	 * 版面分析：发布轻量级版面分析模型，速度提升**12倍**，平均CPU耗时仅需**70ms**！
...
- 版面分析模型参数量减少87%，推理速度提升12倍，精度提升0.4%；
...
|:------:|:------:|:------:|:------:|:------:|
| 1    |  PP-YOLOv2(640*640)  |  326  | 93.6% |  512  |
...
| 4    | 实验3 + UDML蒸馏                | 1.1     | 93.10% | 23.71       | 675.58      |
| 5    | 实验3 + UDML蒸馏                | 1.1     | **93.10%** | **15.49**       | **675.58**      |
