...
- 2020.9.17 更新[英文识别模型](./doc/doc_ch/models_list.md#english-recognition-model)和[多语言识别模型](doc/doc_ch/models_list.md#english-recognition-model)，已支持`德语、法语、日语、韩语`，更多语种识别模型将持续更新。
