<div align="center">
  <p>
      <img width="100%" src="./docs/images/Banner.png" alt="Баннер PaddleOCR"></a>
  </p>

<!-- language -->
[中文](./README.md) | [English](./README_en.md) | [العربية](./README_ar.md) | [Español](./README_es.md) | [Français](./README_fr.md) | [日本語](./README_ja.md) | [한국어](./README_ko.md) | Русский | [繁体中文](./README_zh_TW.md)
...
20 мая 2025 года команда PaddlePaddle представила PaddleOCR 3.0, полностью совместимый с официальным релизом фреймворка **PaddlePaddle 3.0**. Это обновление дополнительно **повышает точность распознавания текста**, добавляет поддержку **распознавания нескольких типов текста** и **распознавания рукописного ввода**, а также удовлетворяет растущий спрос на **высокоточный парсинг сложных документов** со стороны приложений на базе больших моделей. В сочетании с **ERNIE 4.5T** он значительно повышает точность извлечения ключевой информации. PaddleOCR 3.0 также представляет поддержку отечественных аппаратных платформ, таких как **KUNLUNXIN** и **Ascend**. Полную документацию по использованию см. в [Документации PaddleOCR 3.0](https://paddlepaddle.github.io/PaddleOCR/latest/en/index.html).
...
- Интеллектуальное решение для понимания документов [PP-ChatOCRv4](./docs/version3.x/algorithm/PP-ChatOCRv4/PP-ChatOCRv4.en.md): Нативно работает на большой модели WenXin 4.5T, достигая на 15 процентных пунктов более высокой точности, чем его предшественник. [Онлайн-демо](https://aistudio.baidu.com/community/app/518493/webUI)
...
<div align="center">
  <p>
      <img width="100%" src="./docs/images/Arch.png" alt="Архитектура PaddleOCR"></a>
  </p>
</div>
...
- **PP-ChatOCRv4**: Интеллектуальное понимание документов – Извлекайте ключевую информацию, а не просто текст из изображений/PDF.
   ...
   2. 💻 Нативная поддержка **ERNIE4.5 Turbo**, с совместимостью для развертывания больших моделей через PaddleNLP, Ollama, vLLM и другие.
...
use_mllm = False
# Если используется мультимодальная большая модель, необходимо запустить локальный сервис mllm. Вы можете обратиться к документации: https://github.com/PaddlePaddle/PaddleX/blob/release/3.0/docs/pipeline_usage/tutorials/vlm_pipelines/doc_understanding.md для выполнения развертывания и обновления конфигурации mllm_chat_bot_config.
if use_mllm:
...
<div align="center">
  <p>
     <img width="100%" src="./docs/images/demo.gif" alt="Демо PP-OCRv5"></a>
  </p>
</div>

<div align="center">
  <p>
     <img width="100%" src="./docs/images/blue_v3.gif" alt="Демо PP-StructureV3"></a>
  </p>
</div>
