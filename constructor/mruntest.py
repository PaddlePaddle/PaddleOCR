...
if __name__ == "__main__":
    ...
    # pdf_path='./constructor/source/12mckinsey/'
    # pdf_path = "./constructor/source/test/"
    # pdf_path="/home/ubuntu/moe/PaddleOCR_m/constructor/pdfsource/test"
    # moe/PaddleOCR_m/constructor/source/12mckinsey
    ...
    pdf_path="/home/ubuntu/moe/PaddleOCR_m/constructor/pdfsource/new_week_in_charts"
    save_folder = './constructor/result/pdf_test/new_week_in_charts/'
    # moe/PaddleOCR_m/constructor/result/12pp_result
    font_path = 'doc/fonts/simfang.ttf'  # 字体位置
    batch_size = 10  # 根据显存调整批次大小\

    start_total_time= time.time() # 开始时间

    PaddleImages(pdf_path, save_folder, font_path, batch_size)
    # ProcessSingelPDF(pdf_path, save_folder, font_path, batch_size)
    
    end_total_time = time.time() # 结束时间
