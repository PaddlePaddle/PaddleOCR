...
from paddleocr.ppocr.modeling.backbones import build_backbone
from paddleocr.ppocr.modeling.necks import build_neck
from paddleocr.ppocr.modeling.heads import build_head
