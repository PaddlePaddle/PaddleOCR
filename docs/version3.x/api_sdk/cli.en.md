...
- `--model`: model name. OCR defaults to PP-OCRv5; document parsing defaults to PaddleOCR-VL-1.5 when omitted. Models are validated through the PaddleOCR official API SDK model classification helpers.
