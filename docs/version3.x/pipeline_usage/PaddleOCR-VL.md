...
镜像中仅预装飞桨框架，未安装其他推理引擎（如 Transformers）。
...
```
  ...
  对于其他 CUDA 版本，请参考飞桨安装文档：<https://www.paddlepaddle.org.cn/install/quick?docurl=/documentation/docs/zh/develop/install/pip/linux-pip.html>
