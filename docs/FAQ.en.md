...
**A**: PaddleOCR has completed adaptation to Windows and MAC systems. Two points should be noted during operation:
    1. In [Quick installation](https://www.paddleocr.ai/main/en/quick_start.html), if you do not want to install docker, you can skip the first step and start with the second step.
